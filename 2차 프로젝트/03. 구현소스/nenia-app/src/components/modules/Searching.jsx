...
// console.log("데이터가 selData에 잘 모아졌나?",selData);
  ...
  const newList = selData.filter((v) => {
    ...
    if (
      ...
      ((chk[0] ? v.category == "bread" : false) ||
        (chk[1] ? v.category == "ricecake" : false) ||
        (chk[2] ? v.category == "mando" : false) ||
        (chk[3] ? v.category == "icecream" : false)) 
              ...
              <div className="chkbx">
                <ul>
                  <li>
                    ...
                    <ol>
                      <li>
                       브레드({newList.filter(v => v.category === "bread").length})
                        ...
                        />
                        {/* 디자인노출 라벨 */}
                        <label htmlFor="bread" className="chklb"></label>
                      </li>
                      <li>
                        떡({newList.filter(v => v.category === "ricecake").length})
                        {/* 숨긴 체크박스 */}
                        <input
                          type="checkbox"
                          id="ricecake"
                        ...
                        />
                        {/* 디자인노출 라벨 */}
                        <label htmlFor="ricecake" className="chklb"></label>
                      </li>
                      <li>
                        만두({newList.filter(v => v.category === "mando").length})
                        {/* 숨긴 체크박스 */}
                        <input
                          type="checkbox"
                          id="mando"
                        ...
                        />
                        {/* 디자인노출 라벨 */}
                        <label htmlFor="mando" className="chklb"></label>
                      </li>
                      <li>
                        아이스크림({newList.filter(v => v.category === "icecream").length})
                        {/* 숨긴 체크박스 */}
                        <input
                          type="checkbox"
                          id="icecream"
                        ...
                        />
                        {/* 디자인노출 라벨 */}
                        <label htmlFor="icecream" className="chklb"></label>
                      </li>
                    </ol>
                  </li>
                </ul>
